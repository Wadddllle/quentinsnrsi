...
sol = obj.modifiers.new("solidify","SOLIDIFY"); sol.thickness = 3.0; sol.offset = 0.0
...
bpy.ops.wm.stl_export(filepath=f"{out_dir}/ab_struts_solidify3.stl", export_selected_objects=False)
print(f"AB_RESULT struts_solidify3: faces={len(obj.data.polygons)} volume={vol:.1f} bbox={[round(x,1) for x in obj.dimensions]}", file=sys.stderr)
